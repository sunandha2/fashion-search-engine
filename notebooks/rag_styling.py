...
# RAG Context — Indian fashion knowledge base
RAG_CONTEXT = """
...
def generate_styling_recommendation(query, search_results):
    """Use Groq + RAG context to generate personalized styling recommendation"""

    # Format top 5 results as context for the LLM
    results_text = "\n".join([
...
for query in test_queries:
    ...
    # Step 2: RAG — send results as context to Groq
